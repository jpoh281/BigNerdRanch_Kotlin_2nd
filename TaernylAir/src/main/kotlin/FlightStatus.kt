data class FlightStatus(
    ...
    val hasBooleanStarted: Boolean
        get() = departureTimeInMinute in 15..60

    val isBoardingOver : Boolean
        get() = departureTimeInMinute < 15

    val isEligibleToBoard : Boolean
        get() = departureTimeInMinute in 15 .. passengerLoyaltyTier.boardingWindowStart

    val boardingState : BoardingState
        get() = when {
            ...
            hasBooleanStarted -> BoardingState.WaitingToBoard
